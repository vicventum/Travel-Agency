...
},{"./bundle-url":"../../../../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"app/vendor/materialize/materialize.min.css":[function(require,module,exports) {
...
module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"./..\\..\\img\\man.jpg":[["man.301a63ab.jpg","img/man.jpg"],"img/man.jpg"],"_css_loader":"../../../../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/css-loader.js"}],"../node_modules/@babel/runtime/helpers/typeof.js":[function(require,module,exports) {
...
},{}],"app/vendor/materialize/materialize.min.js":[function(require,module,exports) {
var define;
...
window.cash = function () {
  var i,
      ...
      e = function e() {},
      h = function h(t) {
    return (0, _typeof2.default)(t) == (0, _typeof2.default)(e) && t.call;
  },
      d = function d(t) {
...
document.addEventListener("keydown", docHandleKeydown, !0), document.addEventListener("keyup", docHandleKeyup, !0), document.addEventListener("focus", docHandleFocus, !0), document.addEventListener("blur", docHandleBlur, !0), M.initializeJqueryWrapper = function (n, s, o) {
  jQuery.fn[s] = function (e) {
    ...
    if ("object" == (0, _typeof2.default)(e) || !e) return n.init(this, e), this;
...
M.anime = function () {
  ...
  var t = {
    ...
    return _createClass(s, [{
      ...
      value: function value() {
        var t = document.createElement("div");
        return t.classList.add("toast"), this.options.classes.length && i(t).addClass(this.options.classes), ("object" == (typeof HTMLElement === "undefined" ? "undefined" : (0, _typeof2.default)(HTMLElement)) ? this.message instanceof HTMLElement : this.message && "object" == (0, _typeof2.default)(this.message) && null !== this.message && 1 === this.message.nodeType && "string" == typeof this.message.nodeName) ? t.appendChild(this.message) : this.message.jquery ? i(t).append(this.message[0]) : t.innerHTML = this.message, s._container.appendChild(t), t;
      }
    }, {
      key: "_animateIn",
      value: function value() {
  ...
  var e = {
    ...
    function B(t, e) {
      ...
      (i.el.M_Datepicker = i).options = g.extend({}, B.defaults, e), e && e.hasOwnProperty("i18n") && "object" == (0, _typeof2.default)(e.i18n) && (i.options.i18n = g.extend({}, B.defaults.i18n, e.i18n)), i.options.minDate && i.options.minDate.setHours(0, 0, 0, 0), i.options.maxDate && i.options.maxDate.setHours(0, 0, 0, 0), i.id = M.guid(), i._setupVariables(), i._insertHTMLIntoDOM(), i._setupModal(), i._setupEventHandlers(), i.options.defaultDate || (i.options.defaultDate = new Date(Date.parse(i.el.value)));
...
require("./app/vendor/materialize/materialize.min.css");
